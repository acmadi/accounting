<!-- .form-inline -->
<form class="form-inline text-right" action="{{ route('cari_stock') }}" method="post">
  ...
  <select name="sort" id="sort" class="form-control">
    ...
    <optgroup label="Dibuat">
      <option value="pemasukan.created_at-asc">Ascending</option>
      <option value="pemasukan.created_at-desc">Descending</option>
    </optgroup>

    <optgroup label="Dirubah">
      <option value="pemasukan.updated_at-asc">Ascending</option>
      <option value="pemasukan.updated_at-desc">Descending</option>
    </optgroup>
