...
<html lang="en">
    <head>
        ...
        <title>Login to marketing </title>
    ...
    <body>
        <div class="container">
			...
			<header>
				...
				<img src="{{ asset('assetlogin/images/logo.png') }}" align="absmiddle">
			...
			<section class="main">
				...
				<form role="form" action="{{ route('loginmarketing') }}" method="post" class="form-2">
					<h1><span class="log-in"></span> <span class="sign-up">Login Marketing</span></h1>
