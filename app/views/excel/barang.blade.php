...
$excel->getProperties()
  ...
  ->setDescription('Data Barang '.$corp->nama);
...
$sheet->setCellValue('A5', 'No')
  ...
  ->setCellValue('E5', 'Harga Beli')
  ->setCellValue('F5', 'Harga Jual');
unset($style);
...
// semua tabel
$sheet->getStyle('A6:F'.(count($barang) + 5))
  ->applyFromArray($style);
$sheet->getStyle('A6:F'.(count($barang) + 5))
  ->getAlignment()
  ->setWrapText(true);
...
// kolom nama
$sheet->getStyle('C6:C'.(count($barang) + 5))
  ->getAlignment()
...
foreach ($barang as $data) {
  ...
  $sheet->setCellValue('A'.($i + 5), $i)
    ...
    ->setCellValue('E'.($i + 5), ($data->beli)   ?: '-')
    ->setCellValue('F'.($i + 5), ($data->jual)   ?: '-');
