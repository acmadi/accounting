...
$excel->getProperties()
  ...
  ->setSubject('Data Pengeluaran')
  ->setDescription('Data Pengeluaran '.$corp->nama);
...
$sheet->setCellValue('A1', $corp->nama)
  ->setCellValue('A2', 'DATA PENGELUARAN')
...
// semua tabel
$sheet->getStyle('A6:I'.(count($pengeluaran) + 5))
  ->applyFromArray($style);
$sheet->getStyle('A6:I'.(count($pengeluaran) + 5))
  ->getAlignment()
  ->setWrapText(true);
...
// kolom nama
$sheet->getStyle('C6:C'.(count($pengeluaran) + 5))
  ->getAlignment()
  ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY);
$sheet->getStyle('E6:E'.(count($pengeluaran) + 5))
  ->getAlignment()
  ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY);
